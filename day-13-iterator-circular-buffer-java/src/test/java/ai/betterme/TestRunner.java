 ...
 * with {@code test} in {@link CircularBufferTest}, reports PASS/FAIL per test,
 * and exits non-zero if anything fails (so it works in CI / scripts).
 *
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = CircularBufferTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        CircularBufferTest suite = new CircularBufferTest();
