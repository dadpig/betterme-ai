 ...
 * annotated with {@link Test} in {@link CountingBitsTest}, reports
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = CountingBitsTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        CountingBitsTest suite = new CountingBitsTest();
