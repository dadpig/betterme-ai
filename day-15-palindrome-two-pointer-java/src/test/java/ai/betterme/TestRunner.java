 ...
 * annotated with {@link Test} in {@link PalindromeTest}, reports PASS/FAIL
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = PalindromeTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        PalindromeTest suite = new PalindromeTest();
