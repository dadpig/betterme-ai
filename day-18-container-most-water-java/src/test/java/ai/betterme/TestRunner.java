 ...
 * annotated with {@link Test} in {@link ContainerWithMostWaterTest}, reports
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = ContainerWithMostWaterTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        ContainerWithMostWaterTest suite = new ContainerWithMostWaterTest();
