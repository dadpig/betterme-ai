 ...
 * {@link #assertTrue(boolean, String)},
 * {@link #assertFalse(boolean, String)},
 ...
 *
 * <p>Failures are reported by throwing {@link AssertionError}, exactly as
 * the real Jupiter library does.
 */
public final class Assertions {
     ...
     * {@code expectedType} (the real Jupiter rule: subtypes count as a
     * match). Returns the thrown exception so the caller can make further
     * assertions on it.
     */
