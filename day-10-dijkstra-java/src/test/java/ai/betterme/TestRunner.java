 ...
 * with {@code test} in {@link DijkstraTest}, reports PASS/FAIL per test, and
 * exits non-zero if anything fails (so it works in CI / scripts too).
 *
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = DijkstraTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        DijkstraTest suite = new DijkstraTest();
