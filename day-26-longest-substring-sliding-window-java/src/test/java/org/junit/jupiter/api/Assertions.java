...
/**
 * Day 26 - JUnit 5 (Jupiter) on-ramp shim (continued from Day 14-25).
 *
 ...
 * {@link #assertArrayEquals(int[], int[])},
...
public final class Assertions {
    ...
    public static void assertArrayEquals(int[] expected, int[] actual) {
        if (!Arrays.equals(expected, actual)) {
            throw new AssertionError("expected array: <" + Arrays.toString(expected)
