 ...
 * annotated with {@link Test} in {@link LongestSubstringTest}, reports
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = LongestSubstringTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        LongestSubstringTest suite = new LongestSubstringTest();
