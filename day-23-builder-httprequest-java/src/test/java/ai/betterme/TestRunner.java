 ...
 * annotated with {@link Test} in {@link HttpRequestTest}, reports
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = HttpRequestTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        HttpRequestTest suite = new HttpRequestTest();
