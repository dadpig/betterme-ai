...
/**
 * Day 19 - JUnit 5 (Jupiter) on-ramp shim (continued from Day 14/15/16/17/18).
 *
 ...
 * unchanged once a real JUnit 5 jar is on the classpath. The
 * {@code assertEquals(Object, Object)} overload uses {@code equals}, so it
 * compares {@code List<List<Integer>>} structures by value as expected.
 */
