 ...
 * annotated with {@link Test} in {@link ThreeSumTest}, reports PASS/FAIL per
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = ThreeSumTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        ThreeSumTest suite = new ThreeSumTest();
