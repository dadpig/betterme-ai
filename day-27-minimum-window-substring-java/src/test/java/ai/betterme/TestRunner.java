 ...
 * annotated with {@link Test} in {@link MinimumWindowSubstringTest}, reports
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = MinimumWindowSubstringTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        MinimumWindowSubstringTest suite = new MinimumWindowSubstringTest();
