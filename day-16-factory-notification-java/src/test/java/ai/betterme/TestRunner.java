 ...
 * annotated with {@link Test} in {@link NotificationsTest}, reports PASS/FAIL
 * per test, and exits non-zero if anything fails.
 *
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = NotificationsTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        NotificationsTest suite = new NotificationsTest();
