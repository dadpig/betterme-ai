 ...
 * annotated with {@link Test} in {@link ValidPalindromeIITest}, reports
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = ValidPalindromeIITest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        ValidPalindromeIITest suite = new ValidPalindromeIITest();
