 ...
 * annotated with {@link Test} in {@link SingleNumberTest}, reports
...
public final class TestRunner {
    ...
    public static void main(String[] args) throws Exception {
        Method[] methods = SingleNumberTest.class.getDeclaredMethods();
        ...
        int passed = 0;
        int failed = 0;
        SingleNumberTest suite = new SingleNumberTest();
